...
noise_dim = 6 # dimension of noise vector for generator
gen_dim = 6 # dimension of generator's output vector
num_first = 10_000 # train on "num_first" data set
...
if __name__ == '__main__':
    ...
    figure.savefig('WGAN.png')
    print('Training finished, result is saved in WGAN.png')
